...
<head>
    <meta charset="UTF-8">
    <title>Notificación de Cita - Pet Spa</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🐾 Pet Spa</h1>
            <p>Notificación de tu cita</p>
        </div>
        
        <p>Hola <strong>{{ $cita->mascota->cliente->usuario->nombres ?? 'Cliente' }}</strong>,</p>
        
        @if($tipo == 'confirmacion')
            <p>✅ <strong>Tu cita ha sido confirmada.</strong> Aquí están los detalles:</p>
        @else
            <p>📅 <strong>Recordatorio de tu cita</strong> para mañana:</p>
        @endif
