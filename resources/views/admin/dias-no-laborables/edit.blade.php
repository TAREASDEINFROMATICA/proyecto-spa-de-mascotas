...
<html>
<head>
    <title>Editar Día No Laborable - Admin</title>
    <meta charset="UTF-8">
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h2><i class="fas fa-edit"></i> Editar Día No Laborable</h2>
            </div>
            ...
            <div class="content">
                ...
                <form method="POST" action="/admin/dias-no-laborables/{{ $dia->id_dia_no_laborable }}?token={{ $token }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha" value="{{ old('fecha', $dia->fecha) }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="tipo" required>
                            @foreach($tipos as $valor => $nombre)
                                <option value="{{ $valor }}" {{ $dia->tipo == $valor ? 'selected' : '' }}>
                                    {{ $nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="motivo" rows="3">{{ old('motivo', $dia->motivo) }}</textarea>
                    </div>
