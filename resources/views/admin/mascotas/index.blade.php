...
<html>
<head>
    <title>Todas las Mascotas - Pet Spa</title>
    <meta charset="UTF-8">
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-ver { background: #2196F3; color: white; }
        .btn-ver:hover { background: #1976D2; transform: scale(1.02); }
        .btn-desactivar { background: #f44336; color: white; }
        .btn-desactivar:hover { background: #d32f2f; transform: scale(1.02); }
        .btn-activar { background: #4CAF50; color: white; }
        .btn-activar:hover { background: #45a049; transform: scale(1.02); }
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="/cliente/mascotas/{{ $mascota->id_mascota }}?token={{ $token }}" class="btn btn-ver">
                                        <i class="fas fa-eye"></i> Ver
                                    </a>
                                    @if($mascota->estado == 'activa')
                                        <a href="/admin/mascotas/{{ $mascota->id_mascota }}/activate?token={{ $token }}" class="btn btn-desactivar" onclick="return confirm('¿Desactivar esta mascota?')">
                                            <i class="fas fa-ban"></i> Desactivar
                                        </a>
                                    @else
                                        <a href="/admin/mascotas/{{ $mascota->id_mascota }}/activate?token={{ $token }}" class="btn btn-activar">
