...
<html>
<head>
    <title>Detalle de Venta - Pet Spa</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-print { background: #607d8b; color: white; border: none; padding: 10px 20px; border-radius: 12px; cursor: pointer; display: inline-flex; align-items: center; gap: 8px; }
        ...
        .total { text-align: right; font-size: 18px; font-weight: 700; margin-top: 15px; padding-top: 15px; border-top: 2px solid #e0e0e0; }
        .total span { font-size: 24px; color: #4CAF50; }
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-receipt"></i> Detalle de Venta #{{ $venta->id_venta }}</h1>
        ...
        <div class="content">
            ...
            <div class="info-card">
                ...
                <div class="info-grid">
                    ...
                    <div>
                        ...
                        <div class="info-value">{{ $venta->comprobante->numero_comprobante ?? 'No generado' }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="info-grid">
                    <div>
                        ...
                        <div class="info-value">{{ $venta->cliente->usuario->nombres }} {{ $venta->cliente->usuario->apellidos }}</div>
                    </div>
                    <div>
                        <div class="info-label">Email</div>
                        <div class="info-value">{{ $venta->cliente->usuario->correo }}</div>
                    </div>
                    <div>
                        <div class="info-label">Teléfono</div>
                        <div class="info-value">{{ $venta->cliente->usuario->telefono ?? 'No registrado' }}</div>
                    </div>
                    <div>
                        <div class="info-label">Dirección</div>
                        <div class="info-value">{{ $venta->cliente->direccion ?? 'No registrada' }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="info-grid">
                    ...
                    <div>
                        ...
                        <div class="info-value">Bs {{ number_format(($venta->pagos->first()->monto ?? $venta->total) - $venta->total, 2) }}</div>
                    </div>
                    <div>
            ...
            <div style="text-align: center; margin-top: 30px; padding: 20px; background: #e8f5e9; border-radius: 12px;">
                ...
                <p style="margin-top: 10px;">¡Gracias por tu compra! Venta registrada exitosamente.</p>
            </div>
        </div>
    </div>
</body>
